...
if __name__ == "__main__":
    stat_sharing_array('all_hicat_horstv_summary.xls', method="hicat")
    stat_sharing_array('all_graph_horstv_summary.xls', method="hormon")
    # stat_sharing_stv('all_hicat_horstv_summary.xls', method="hicat")
    # stat_sharing_stv('all_graph_horstv_summary.xls', method="hormon")
