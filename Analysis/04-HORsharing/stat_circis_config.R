...
############HiCAT#################
hicat_df <- read.csv("/share/home/zhanglab/user/sunyanqing/vscode_scripts/HORmining/hicat_hor_final_summary.xls", sep="\t", header=TRUE)
head(hicat_df)
...
############HORmon#################
hormon_df <- read.csv("/share/home/zhanglab/user/sunyanqing/vscode_scripts/HORmining/graph_hor_final_summary.xls", sep="\t", header=TRUE)
head(hormon_df)
